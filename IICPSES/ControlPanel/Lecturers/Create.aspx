...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="row">
        <div class="col-sm-12">
            <h2>
                <asp:Label ID="lbLecturerTitle" runat="server" CssClass="page page-header" Text="Create Lecturer"></asp:Label></h2>
            <br/>
            ...
            <br/>
            <asp:Label Text="ID" CssClass="label label-info" runat="server" />
            <asp:TextBox runat="server" ID="txtID" CssClass="form-control" placeholder="ID" required="required" autofocus="autofocus" />
            <p>
                <asp:Label runat="server" ID="lblStatus_CreateLecturer" /></p>
